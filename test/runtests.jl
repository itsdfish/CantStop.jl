...
@safetestset "return_to_start_position!" begin
    ...
    game = Game()
    game.pieces[:p1] = Dict(
        2 => Piece(; id = :p1, is_runner = true, max_row = 8, row = 2, start_row = 0),
...
@safetestset "check_winners!" begin
    ...
    game = Game()
    game.pieces[:p1] = Dict(
        2 => Piece(; id = :p1, is_runner = true, max_row = 8, row = 9, start_row = 0),
        3 => Piece(; id = :p1, is_runner = true, max_row = 10, row = 3, start_row = 1),
        4 =>
            Piece(; id = :p1, is_runner = false, max_row = 10, row = 10, start_row = 1),
    )
...
@safetestset "set_status!" begin
    ...
    game = Game()
    game.pieces[:p1] = Dict(
        2 => Piece(; id = :p1, is_runner = false, max_row = 8, row = 9, start_row = 0),
